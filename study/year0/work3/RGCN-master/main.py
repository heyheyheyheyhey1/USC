...
def main(args):
    ...
    entity2id, relation2id, train_triplets, test_triplets = load_data('./data/drug_disease_drug')
    all_triplets = torch.LongTensor(np.concatenate((train_triplets, test_triplets)))
