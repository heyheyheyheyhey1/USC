...
if __name__ == '__main__':
    ...
    download_datasets([
        ...
        ('GO_MF', 'gomf'),
        ('GTEx_TissueGene', 'gtextissue'),
        ('GTEx_SampleGene', 'gtexsample'),
        # ('GTEx eQTL', 'gtexeqtl'),
        ...
        ('HPA_CellLineGene', 'hpacelllines'),
        ('HPA_TissueGene', 'hpatissuesmrna'),
        ('HPA_TissueProtein', 'hpatissuesprotein'),
        ('HPA_TissueSample', 'hpasamples'),
        ...
        ('TISSUES_curatProtein', 'jensentissuecurated'),
